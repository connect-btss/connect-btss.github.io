      ...
      <!--- What are the challenges --->
        <div style="display: flex; gap: 20px; align-items: flex-start; flex-wrap: wrap; margin-bottom: 40px;">
          <div class="box-white">
            ...
            <br>
            <!--- making flex container --->
            <div class="flex-container" style="display:flex; gap:30px; flex-wrap:wrap; align-items:flex-start;">
              <!--- left column --->
              <div style="flex:1; min-width:300px;">
                <!--- first flex item --->
                <div class="flex-item sidebar-subheading" id="credibility">
                  <ul>
                    <li>
                ...
                </div> <!--- clsoing third flex item --->
                <br>
                <div class"flex-item sidebar-subheading" id="generalizability">
                  <ul>
                    <li>
